...
Source:  https://cantera.org/examples/python/thermo/vapordome.py.html
Modified to plot a point on the vapor dome.
"""
...
def vapor_dome(T,s):
    ...
    # Add the given point to the plot
    Temp_C = T
    TK = 273.5 + Temp_C
    entropy = S
    plt.plot(entropy, Temp_C, 'ro', label = 'x value')  # Plot the point as a red circle
